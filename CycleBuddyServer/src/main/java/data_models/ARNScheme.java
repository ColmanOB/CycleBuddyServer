 ...
 * 
 * A scheme can correspond to one city if that city is specified, 
 * otherwise it includes all cities where An Rothar Nua operates
 * 
 * @author Colman
 * @since 2018-04-13
 */
