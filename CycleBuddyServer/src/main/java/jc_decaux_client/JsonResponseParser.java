...
/**
 * Uses Google's Gson library to parse a JSON response from the API into wrapper objects for ease of access to each element of the response.
 * 
 * @author Colman O'B
 * @since 2017-11-30
 */
...
public class JsonResponseParser 
	 ...
	 * 
	 * @param jsonResponse a string of JSON data retrieved from the JCDecaux API
	 */
